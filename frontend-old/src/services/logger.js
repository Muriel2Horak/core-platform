...
class Logger {
  constructor() {
    ...
    // Konfigurace podle prostředí - nahrazeno za standardní Node.js env  
  ...
  extractPageFromUrl(url) {
    try {
      ...
      const pageRoutes = {
        ...
        '/admin-core/users': 'user_management',
        '/admin-core/tenants': 'tenant_management',
      ...
      return pageRoutes[pathname] || pathname.replace(/^\//, '').replace(/\//g, '_') || 'unknown';
    } catch {
      return 'unknown';
    }
  }
