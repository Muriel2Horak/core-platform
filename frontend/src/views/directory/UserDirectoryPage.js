...
const UserDirectoryPage = () => {
  ...
  const isCoreAdmin = userInfo?.roles?.includes('CORE_ROLE_ADMIN');
  ...
  useEffect(() => {
    loadUsers();
  }, [page, debouncedQuery, searchFilters.source, searchFilters.tenantId]);
  ...
  }, [page, debouncedQuery, searchFilters.source, searchFilters.tenantId, canViewAllTenants]);
