...
def generate_text_report(
    story_id: str, results: Dict[str, PathValidationResult], show_details: bool = True
) -> str:
...
def generate_json_report(
    story_id: str, results: Dict[str, PathValidationResult]
) -> str:
    ...
    # Full report
    report = {"story_id": story_id, "coverage": coverage, "overall": overall}
...
def generate_epic_json_report(
    epic_id: str, story_results: Dict[str, Dict[str, PathValidationResult]]
) -> str:
    ...
    for story_id, results in sorted(story_results.items()):
        ...
        story_data = {
            "story_id": story_id,
            "coverage": {
                category: result.to_dict() for category, result in results.items()
            },
            "overall": overall,
        }
