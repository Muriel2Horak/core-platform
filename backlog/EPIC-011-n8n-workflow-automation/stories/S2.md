# S2: Keycloak OIDC Integration

> **Identity Provider:** Keycloak client setup, user/group mapping, token validation
...
echo "🔐 Creating n8n OIDC client in Keycloak..."
...
if [ "$HTTP_CODE" -eq 201 ]; then
    ...
    echo "⚠️  Client already exists, updating..."
...
echo ""
echo "✅ n8n OIDC client configuration complete!"
echo ""
echo "📋 Client Details:"
...
echo "👥 Creating n8n user groups in Keycloak..."
...
EOF
    ...
    if [ "$HTTP_CODE" -eq 201 ]; then
        ...
        echo "❌ Failed to create group $GROUP (HTTP $HTTP_CODE)"
    fi
done

echo ""
echo "✅ n8n groups created!"
echo ""
echo "📋 Group Permissions:"
echo "   n8n-admins  → Full access + 2FA required"
echo "   n8n-users   → Create/edit workflows"
echo "   n8n-viewers → Read-only access"
```
...
echo "✅ User added to n8n-admins group"
echo ""
