...
# DMS-004-T6: Unit + E2E Tests

> **Parent Story:** [DMS-004: Audit Trail](../README.md)  
...
Tento subtask implementuje **Unit + E2E Tests** pro Audit Trail story.
...
- [ ] Commit message: `feat(DMS-004-T6): Unit + E2E Tests`
