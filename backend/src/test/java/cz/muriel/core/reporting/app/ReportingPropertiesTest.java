...
@TestPropertySource(properties = {
    ...
    "reporting.max-rows=50000",
    "reporting.max-interval-days=92",
    "reporting.default-ttl-seconds=60",
    "reporting.cache.provider=redis",
    "reporting.cache.key-prefix=rpt:",
    "reporting.rate-limit.per-tenant-per-min=120",
    "reporting.cube.base-url=http://cube:4000",
    "reporting.cube.api-token=test-token",
    "reporting.bulk.chunk-size=1000",
    "reporting.bulk.max-affect-rows=500000",
