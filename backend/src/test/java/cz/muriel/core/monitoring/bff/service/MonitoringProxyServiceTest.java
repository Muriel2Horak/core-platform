 ...
 * 
 * TODO: Add integration tests with WireMock or MockWebServer
 * to verify HTTP proxying, header injection, and error handling.
 * 
...
class MonitoringProxyServiceTest {
    ...
    @Test
    @Disabled("Integration test - requires WireMock setup")
