 ...
 * 
 * Verifies: - X-Grafana-Org-Id header is always set by backend (never trusted
 * from client) - Service-Access-Token is always regenerated by backend - Forged
 * headers from clients are ignored - Tenant isolation is enforced
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) @Import(MockMvcTestConfig.class) @ExtendWith(WireMockExtension.class)
class MonitoringHeaderSecurityIT extends AbstractIntegrationTest {
    ...
    void shouldNotTrustClientProvidedOrgId(WireMockServer wireMock) throws Exception {
        ...
        wireMock.verify(WireMock.postRequestedFor(WireMock.urlEqualTo("/api/ds/query"))
                .withHeader("X-Grafana-Org-Id", WireMock.matching("^(?!999999$).*$"))); // NOT
                                                                                        // 999999
    }
    ...
    void shouldNotTrustClientProvidedServiceAccessToken(WireMockServer wireMock) throws Exception {
        ...
        wireMock.verify(WireMock.postRequestedFor(WireMock.urlEqualTo("/api/ds/query")).withHeader(
                "Service-Access-Token", WireMock.matching("^(?!glsa_forged_token_12345$).*$")));
    }
    ...
    void shouldAlwaysSetOrgIdFromTenantMapping(WireMockServer wireMock) throws Exception {
        ...
        wireMock.verify(WireMock.postRequestedFor(WireMock.urlEqualTo("/api/ds/query"))
                .withHeader("X-Grafana-Org-Id", WireMock.matching("\\d+"))); // Should be a numeric
                                                                             // Org ID
    }
    ...
    void shouldIsolateTenantsByOrgId(WireMockServer wireMock) throws Exception {
        ...
        String orgIdA = wireMock.getAllServeEvents().get(0).getRequest()
        ...
        String orgIdB = wireMock.getAllServeEvents().get(1).getRequest()
                .getHeader("X-Grafana-Org-Id");
    ...
    void shouldRejectRequestWithoutTenant() throws Exception {
        ...
        mockMvc.perform(post("/api/monitoring/ds/query").contentType(MediaType.APPLICATION_JSON)
                .content("{\"queries\":[{\"refId\":\"A\",\"expr\":\"{app=\\\"test\\\"}\"}]}"))
