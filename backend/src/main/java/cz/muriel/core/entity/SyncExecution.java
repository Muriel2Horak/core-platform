...
public class SyncExecution {
  ...
  @ElementCollection @CollectionTable(name = "sync_execution_errors", joinColumns = @JoinColumn(name = "sync_execution_id")) @Column(name = "error_message", length = 1000) @Builder.Default
