...
/**
 * Work State Entity
 * Tracks entity-level processing state and locking
 */
@Data
@Entity
@Table(name = "work_state", indexes = {
    @Index(name = "idx_work_state_status", columnList = "status"),
    @Index(name = "idx_work_state_ttl", columnList = "ttl")
})
@IdClass(WorkState.WorkStateId.class)
