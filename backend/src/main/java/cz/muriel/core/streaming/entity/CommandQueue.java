 ...
 * Represents an async command waiting to be processed
 */
@Data
@Entity
@Table(name = "command_queue", indexes = {
    @Index(name = "idx_command_queue_status_priority_available", 
           columnList = "status, priority, available_at"),
    @Index(name = "idx_command_queue_entity_entity_id", 
           columnList = "entity, entity_id"),
    @Index(name = "idx_command_queue_operation_id", 
           columnList = "operation_id"),
    @Index(name = "idx_command_queue_correlation_id", 
           columnList = "correlation_id"),
    @Index(name = "idx_command_queue_tenant_id", 
