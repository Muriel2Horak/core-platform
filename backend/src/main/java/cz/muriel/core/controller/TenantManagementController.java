...
public class TenantManagementController {
  ...
  public TenantManagementController(KeycloakRealmManagementService keycloakRealmManagementService,
      TenantService tenantService, UserDirectoryService userDirectoryService) {
