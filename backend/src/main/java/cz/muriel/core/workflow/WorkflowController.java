...
public class WorkflowController {
    ...
    public ResponseEntity<Map<String, Object>> getCurrentState(
        ...
        WorkflowModels.EntityState state = workflowService.getCurrentState(entityType, entityId, tenantId);
    ...
    public ResponseEntity<List<Map<String, Object>>> getAllowedTransitions(
        ...
        List<Map<String, Object>> response = transitions.stream()
            .map(t -> Map.of(
                "code", t.getCode(),
                "fromCode", t.getFromCode() != null ? t.getFromCode() : "null",
                "toCode", t.getToCode(),
    ...
    public ResponseEntity<Map<String, Object>> applyTransition(
        @PathVariable String entityType,
        @PathVariable String entityId,
        ...
        WorkflowModels.TransitionResult result = workflowService.applyTransition(
            auth, entityType, entityId, tenantId, transitionCode
        );
        ...
        return ResponseEntity.ok(Map.of(
            ...
            "message", result.getMessage(),
            "newState", Map.of(
                "stateCode", result.getNewState().getStateCode(),
                "since", result.getNewState().getSince().toString()
            ),
