 ...
 * 
 * Validates AI policies, prompts, and field annotations.
 * Ensures META_ONLY mode never exposes actual values.
 * 
 * @since 2025-10-14
 */
@Slf4j
...
public class AiSchemaValidator {
  ...
  /**
   * Validate that META_ONLY context doesn't contain actual values
