...
/**
 * Service for resolving tenant to Grafana org mapping.
 * Returns the Grafana organization ID and service account token for a given tenant.
 */
public interface TenantOrgService {
     ...
     * Checks multiple claim locations: tenant_id, tenant, realm_access.groups
     * 
     * @param jwt JWT token
     * @return tenant ID
     */
