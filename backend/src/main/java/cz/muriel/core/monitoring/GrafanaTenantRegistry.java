 ...
 * 
 * In production, this would call Grafana API or database
 * For now, static mapping with admin=1
 */
@Component
@Slf4j
public class GrafanaTenantRegistry {
    ...
    /**
     * Get Grafana org ID for tenant
     * Creates new org if not exists (via provisioning)
     */
