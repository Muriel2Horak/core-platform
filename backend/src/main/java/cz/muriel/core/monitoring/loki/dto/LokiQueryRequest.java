 ...
 * 
 * @see <a href="https://grafana.com/docs/loki/latest/reference/loki-http-api/#query-logs-within-a-range-of-time">Loki API Docs</a>
 */
@Data
@Builder
public class LokiQueryRequest {
   ...
   * Example: {tenant="admin",service="backend"} |= "ERROR"
   */
