 ...
 */
@RestController @RequestMapping("/api/monitoring") @RequiredArgsConstructor @Slf4j
public class MonitoringProxyController {
  ...
  public ResponseEntity<String> query(@AuthenticationPrincipal Jwt jwt,
  ...
  public ResponseEntity<String> dashboard(@AuthenticationPrincipal Jwt jwt,
