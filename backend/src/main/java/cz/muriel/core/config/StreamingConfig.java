 ...
 */
@Configuration @EnableScheduling @EnableKafka @ConditionalOnProperty(name = "streaming.enabled", havingValue = "true", matchIfMissing = false) @ConfigurationProperties(prefix = "streaming")
public class StreamingConfig {
  ...
  public ConsumerFactory<String, String> consumerFactory() {
    ...
    configProps.put(ConsumerConfig.ISOLATION_LEVEL_CONFIG, "read_committed"); // Only read committed
                                                                              // messages
