...
public interface EditLockRepository extends JpaRepository<EditLock, Long> {
  ...
  Optional<EditLock> findByTenantIdAndEntityTypeAndEntityId(String tenantId, String entityType,
      String entityId);
  ...
  void deleteByTenantAndTypeAndId(String tenantId, String entityType, String entityId);
}
