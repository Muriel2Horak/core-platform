...
public class PresenceController {
    ...
    public ResponseEntity<Map<String, Object>> getPresence(
        ...
        if (members != null) {
            for (Object userId : members) {
                ...
                Map<String, Object> presenceData = (Map<String, Object>) redisTemplate.opsForValue().get(presenceKey);
    ...
    public ResponseEntity<Map<String, Object>> getEditingIndicators(
        @PathVariable String entityType,
        @PathVariable String entityId,
        Authentication auth
    ) {
    ...
    private String extractTenantId(Authentication auth) {
        // Implementation depends on your auth structure
        return "unknown"; // TODO: Extract from JWT
    }
}
