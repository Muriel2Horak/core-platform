...
public class PresenceWebSocketHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(@NonNull WebSocketSession session) {
        ...
        session.getAttributes().put("rateLimiter", new RateLimiter(
            webSocketProperties.getRateLimitEventsPerWindow(),
    ...
    protected void handleTextMessage(@NonNull WebSocketSession session, @NonNull TextMessage message) throws Exception {
        ...
        if (!limiter.allowEvent()) {
            ...
            sendError(session, "Rate limit exceeded: max " + 
                webSocketProperties.getRateLimitEventsPerWindow() + " events per " + 
                webSocketProperties.getRateLimitWindowSeconds() + "s");
            return;
        }
    ...
    private void handleJoin(WebSocketSession session, String channel, String userId, String username, 
        ...
        redisTemplate.opsForValue().set(
            ...
            webSocketProperties.getPresenceTtlSeconds(),
            TimeUnit.SECONDS
        );
    ...
    private void handleLeave(WebSocketSession session, String channel, String userId, 
                            String tenantId, String entityType, String entityId) {
        String presenceKey = channel + ":" + userId;
    ...
    private void handleHeartbeat(WebSocketSession session, String channel, String userId, String username) {
        String presenceKey = channel + ":" + userId;
        
        // Refresh TTL
        redisTemplate.expire(presenceKey, webSocketProperties.getPresenceTtlSeconds(), TimeUnit.SECONDS);
    ...
    private void handleEditStart(WebSocketSession session, String tenantId, String entityType, 
        ...
        redisTemplate.opsForValue().set(
            editKey,
            Map.of("userId", userId, "username", username, "fieldId", fieldId != null ? fieldId : "", 
                "ts", Instant.now().toString()),
            30,
            TimeUnit.SECONDS
        );
        
        log.debug("Edit started: entity={}/{}, field={}, user={}", entityType, entityId, fieldId, userId);
    }
    ...
    private void handleEditStop(WebSocketSession session, String tenantId, String entityType, 
        ...
        log.debug("Edit stopped: entity={}/{}, field={}, user={}", entityType, entityId, fieldId, userId);
    }

    private void broadcastPresenceEvent(String channel, String event, String userId, String username) {
