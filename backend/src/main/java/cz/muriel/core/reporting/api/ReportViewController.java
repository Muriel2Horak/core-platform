...
public class ReportViewController {
     ...
     */
    @GetMapping
    public ResponseEntity<List<ReportView>> getAccessibleViews(
        ...
        List<ReportView> views = reportViewRepository.findByTenantIdAndEntity(
    ...
    public ResponseEntity<ReportView> getView(@PathVariable UUID id) {
        return reportViewRepository.findById(id)
    ...
    public ResponseEntity<ReportView> createView(
        ...
        log.info("Created report view: id={}, entity={}, name={}", 
            saved.getId(), saved.getEntity(), saved.getName());
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyRole('TENANT_ADMIN', 'USER')")
    public ResponseEntity<ReportView> updateView(
