...
public class ReportQueryController {
    ...
    public ResponseEntity<QueryResponse> executeQuery(
        ...
        log.debug("Executing report query: entity={}, measures={}", 
            request.getEntity(), request.getMeasures());
    ...
    public ResponseEntity<?> getEntityMetadata(
    ...
    public ResponseEntity<?> validateQuery(
            @Valid @RequestBody QueryRequest request,
            Authentication authentication) {
