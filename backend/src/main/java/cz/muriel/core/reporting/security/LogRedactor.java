 ...
 * 
 * Redacts sensitive fields from logs to prevent PII leakage:
 ...
 * Usage:
 * ```java
 * log.info("User data: {}", logRedactor.redact(userData));
 * ```
 * 
 * OWASP Compliance:
 * - A1:2021 - Broken Access Control (prevent PII leakage in logs)
 * - A4:2021 - Insecure Design (secure logging practices)
 */
@Slf4j
@Component
