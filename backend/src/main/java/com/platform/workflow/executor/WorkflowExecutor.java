 ...
 * 
 * Executes automatic workflow actions (e.g., SendEmail, NotifySlack,
 * UpdateInventory).
 * 
 * Features: - Async execution with CompletableFuture - Rollback/compensation on
 * failure - Metadata input/output for context passing
 * 
 * @since 2025-01-14
 */
public interface WorkflowExecutor {
   ...
   */
  CompletableFuture<Map<String, Object>> execute(String entityType, String entityId,
   ...
   */
  CompletableFuture<Void> compensate(String entityType, String entityId, String actionCode,
   ...
   */
  record RetryPolicy(int maxAttempts, long initialDelayMs, long maxDelayMs,
