 ...
 * 
 * Sends webhook notifications to external systems (Slack, MS Teams, custom
 * endpoints). Example: Invoice paid → Notify accounting system
 * 
 * @since 2025-01-14
 */
@Component
public class WebhookNotificationExecutor implements WorkflowExecutor {
  ...
  public CompletableFuture<Map<String, Object>> execute(String entityType, String entityId,
    ...
    return CompletableFuture.supplyAsync(() -> {
      String webhookUrl = (String) context.getOrDefault("webhookUrl",
      ...
      return Map.of("webhookSent", true, "responseCode", 200, "webhookUrl", webhookUrl);
    });
  }
  ...
  public boolean supports(String actionCode) {
    return actionCode != null && (actionCode.contains("notify") || actionCode.contains("webhook")
