 ...
 * 
 * Sends email notifications on workflow transitions. Example: Order approved →
...
public class SendEmailExecutor implements WorkflowExecutor {
  ...
  public CompletableFuture<Map<String, Object>> execute(String entityType, String entityId,
    ...
    return CompletableFuture.supplyAsync(() -> {
      ...
      log.info("Sending email: template={}, recipient={}, subject={}", template, recipient,
          subject);
      ...
      return Map.of("emailSent", true, "messageId", "msg-" + System.currentTimeMillis(),
          "recipient", recipient);
    });
  }
