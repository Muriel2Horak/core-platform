...
public class WorkflowMonitoringService {
    ...
    public List<StateDistribution> getStateDistribution(String entityType, String tenantId) {
        ...
        return jdbcTemplate.query(
                sql,
                (rs, rowNum) -> new StateDistribution(
    ...
    public TransitionMetrics getTransitionMetrics(String entityType, String tenantId, Instant since) {
        ...
        return jdbcTemplate.queryForObject(
                sql,
                (rs, rowNum) -> new TransitionMetrics(
                        rs.getLong("total_transitions"),
     ...
     */
    public List<StuckInstance> findStuckInstances(String entityType, String tenantId, int hoursThreshold) {
    ...
    public List<SLAViolation> getSLAViolations(String entityType, String tenantId, int slaMinutes) {
        ...
        return jdbcTemplate.query(
                sql,
                (rs, rowNum) -> new SLAViolation(
                        rs.getLong("id"),
                        rs.getString("entity_id"),
                        rs.getString("current_state"),
                        rs.getTimestamp("started_at").toInstant(),
                        rs.getDouble("minutes_running"),
                        slaMinutes
                ),
                entityType,
                tenantId,
    ...
    public List<ThroughputMetric> getHourlyThroughput(String entityType, String tenantId, int hours) {
        ...
        return jdbcTemplate.query(
                sql,
                (rs, rowNum) -> new ThroughputMetric(
     ...
     */
    public List<StateErrorRate> getErrorRateByState(String entityType, String tenantId, Instant since) {
        String sql = """
            SELECT
                from_state,
    ...
    public record TransitionMetrics(
    ...
    public record WorkflowHealth(
            ...
            Integer stuckInstances,
            Integer slaViolations,
            Double successRate,
            Double avgDurationSeconds,
            Instant timestamp
    ) {}
