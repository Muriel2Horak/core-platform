-- =====================================================
-- U7: Rollback for V7__remove_grafana_integration.sql
-- Recreate Grafana tenant bindings table
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_grafana_tenant_bindings_tenant_id
    ON grafana_tenant_bindings(tenant_id);
CREATE INDEX IF NOT EXISTS idx_grafana_tenant_bindings_grafana_org_id
    ON grafana_tenant_bindings(grafana_org_id);
